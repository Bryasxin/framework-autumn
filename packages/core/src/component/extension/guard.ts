 ...
 * @param target 组件
 */
export const getComponentExtensions = <T extends object>(target: T): IComponentExtension[] => {
 ...
 * @param extensions 扩展
 */
export const setComponentExtensions = <T extends object>(target: T, extensions: IComponentExtension[]) => {
 ...
 * @param extension 扩展
 */
export const addComponentExtension = <T extends object>(target: T, extension: IComponentExtension) => {
